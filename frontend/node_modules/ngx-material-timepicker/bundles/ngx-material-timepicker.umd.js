(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('luxon'), require('@angular/animations'), require('rxjs/operators'), require('@angular/forms'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('ngx-material-timepicker', ['exports', '@angular/core', '@angular/common', 'rxjs', 'luxon', '@angular/animations', 'rxjs/operators', '@angular/forms', '@angular/platform-browser'], factory) :
    (global = global || self, factory(global['ngx-material-timepicker'] = {}, global.ng.core, global.ng.common, global.rxjs, global.luxon, global.ng.animations, global.rxjs.operators, global.ng.forms, global.ng.platformBrowser));
}(this, function (exports, core, common, rxjs, luxon, animations, operators, forms, platformBrowser) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TimeAdapter = /** @class */ (function () {
        ...
        TimeAdapter.formatTime = function (time, format) {
            ...
            return luxon.DateTime.fromFormat(this.parseTime(time, format), timeMask).toFormat(timeFormat).toLowerCase();
        };
        TimeAdapter.convertTimeToDateTime = function (time, format) {
            if (format === void 0) { format = 12; }
            var timeMask = (format === 24) ? TimeFormat.TWENTY_FOUR_SHORT : TimeFormat.TWELVE_SHORT;
            return luxon.DateTime.fromFormat(this.parseTime(time, format), timeMask);
        };
    ...
    var NgxMaterialTimepickerComponent = /** @class */ (function () {
        ...
        NgxMaterialTimepickerComponent.prototype.open = function () {
            ...
            if (!this.disableAnimation) {
                this.animationState = exports.AnimationState.ENTER;
            }
            this.opened.next();
        };
        NgxMaterialTimepickerComponent.prototype.close = function () {
            ...
            this.animationState = exports.AnimationState.LEAVE;
        };
    ...
    exports.ɵa = NgxMaterialTimepickerService;
    exports.ɵb = NgxMaterialTimepickerEventService;
    exports.ɵc = NgxMaterialTimepickerToggleComponent;
    exports.ɵd = NgxMaterialTimepicker24HoursFaceComponent;
    exports.ɵe = NgxMaterialTimepickerHoursFace;
    exports.ɵf = NgxMaterialTimepicker12HoursFaceComponent;
    exports.ɵg = NgxMaterialTimepickerMinutesFaceComponent;
    exports.ɵh = NgxMaterialTimepickerFaceComponent;
    exports.ɵi = NgxMaterialTimepickerButtonComponent;
    exports.ɵj = NgxMaterialTimepickerDialComponent;
    exports.ɵk = NgxMaterialTimepickerDialControlComponent;
    exports.ɵl = NgxMaterialTimepickerPeriodComponent;
    exports.ɵm = StyleSanitizerPipe;
    exports.ɵn = TimeFormatterPipe;
    exports.ɵo = OverlayDirective;
